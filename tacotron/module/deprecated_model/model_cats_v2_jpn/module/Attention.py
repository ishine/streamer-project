...
from tacotron.module.deprecated_model.model_cats_v2_jpn.module.commons import maximum_path


class Attention(nn.Module):
    def __init__(self, enc_hidden, mel_dim, r_factor, att_hidden=128, num_spkr=1, debug=0, **kwargs):
