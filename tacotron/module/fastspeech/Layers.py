...
from tacotron.module.fastspeech.SubLayers import MultiHeadAttention, PositionwiseFeedForward
...
class FFTBlock(torch.nn.Module):
    ...
    def forward(self, query, key, value, non_pad_mask=None, slf_attn_mask=None):
